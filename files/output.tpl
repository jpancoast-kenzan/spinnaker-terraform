...
3.  In yet another separate window, start up the Jenkins tunnel:
	--- cut ---
	ssh -o IdentitiesOnly=yes -i ${private_key} -L 9999:localhost:9999 ${ssh_user}@${bastion_public_ip} 'ssh -o IdentitiesOnly=yes -i /home/${ssh_user}/.ssh/id_rsa -L 9999:localhost:80 -A ${ssh_user}@${jenkins_private_ip}'
	--- end cut ---
